...
class Company(models.Model):
    name = models.CharField('Название', null=False, max_length=100)
...
class PayslipSheet(models.Model):
    ...
    registry = models.ForeignKey(
        PayslipRegistry, 'Реестр', on_delete=models.CASCADE)
